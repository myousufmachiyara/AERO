...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modules = [
            ...
            // Travel Agency — Phase 3: invoices
            'ticket_invoices',
            'tour_invoices',

            // Travel Agency — Phase 4: vendor complaints
            'vendor_complaints',

            // Travel Agency — Phase 5: payments
            'invoice_payments',
        ];
       ...
       // ─────────────────────────────────────────
        ...
        // ─────────────────────────────────────────
        \App\Models\RoomView::insert([
            ['id' => 1, 'name' => 'Haram View',  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 2, 'name' => 'City View',   'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'name' => 'Sea View',    'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 4, 'name' => 'Standard',    'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ]);

        \App\Models\VisaType::insert([
            ['id' => 1, 'name' => 'Visitor', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ...
        \App\Models\ChargeType::insert([
            ['id' => 1, 'name' => 'Withholding Tax', 'code' => 'WHT', 'calculation_type' => 'percentage', 'default_value' => 10, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 2, 'name' => 'Commission',      'code' => 'COM', 'calculation_type' => 'percentage', 'default_value' => 0,  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'name' => 'PSF',              'code' => 'PSF', 'calculation_type' => 'fixed',      'default_value' => 0,  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 4, 'name' => 'Airport Tax',      'code' => 'APT', 'calculation_type' => 'fixed',      'default_value' => 0,  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 5, 'name' => 'City Tax',         'code' => 'CTX', 'calculation_type' => 'fixed',      'default_value' => 0,  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 6, 'name' => 'Airline Tax',      'code' => 'ALT', 'calculation_type' => 'fixed',      'default_value' => 0,  'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ]);
    }
}