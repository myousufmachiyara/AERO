    ...
    <div class="nano-content">
      <nav id="menu" class="nav-main" role="navigation">
        <ul class="nav nav-main">
          ...
          {{-- Travel Agency: Parties --}}
          @if(auth()->user()->can('suppliers.index') || auth()->user()->can('customers.index'))
          <li class="nav-parent">
            <a class="nav-link" href="#"><i class="fa fa-address-book"></i> <span>Parties</span></a>
            <ul class="nav nav-children">
              @can('suppliers.index')
              <li><a class="nav-link" href="{{ route('suppliers.index') }}">Suppliers</a></li>
              @endcan
              @can('customers.index')
          ...
          <li class="nav-parent">
            ...
            <ul class="nav nav-children">
              ...
              @endcan
              @can('hotels.index')
              <li><a class="nav-link" href="{{ route('hotels.index') }}">Hotels</a></li>
              @endcan
              @can('hotel_rooms.index')
              <li><a class="nav-link" href="{{ route('hotel_rooms.index') }}">Room Types</a></li>
              @endcan
              @can('room_views.index')
              <li><a class="nav-link" href="{{ route('room_views.index') }}">Room Views</a></li>
              @endcan
              @can('vehicles.index')
          ...
          <li class="nav-parent">
            ...
            <ul class="nav nav-children">
              ...
              <li><a class="nav-link" href="{{ route('quotations.index') }}">Quotations</a></li>
              @endcan
            ...
            <li class="nav-parent">
                ...
                <ul class="nav nav-children">
                    ...
                    @can('invoice_payments.index')
                      <li><a class="nav-link" href="{{ route('invoice_payments.index') }}">Travel Payments</a></li>
                    @endcan
                </ul>
            </li>
          @endif
          ...
          @if(
            ...
            auth()->user()->can('reports.travel_accounts')
          )
          <li class="nav-parent">
            <a class="nav-link" href="#">
            ...
            <ul class="nav nav-children">
              ...
              @endcan
              @can('reports.travel_vendor')
                <li><a class="nav-link" href="{{ route('reports.travel_vendor') }}">Travel: Vendor</a></li>
              @endcan
              @can('reports.travel_sales')
                <li><a class="nav-link" href="{{ route('reports.travel_sales') }}">Travel: Sales</a></li>
              @endcan
              @can('reports.travel_accounts')
                <li><a class="nav-link" href="{{ route('reports.travel_accounts') }}">Travel: Accounting</a></li>
              @endcan
            </ul>
          </li>
          @endif
